...
class AirlineProjectApplicationTests {
	...
	UserService service;
			...
			void testAdd() {
				...
				user.setEmail("Showingshowing@Gmail.com");
				service.add(user);
			...
			void testFindAll() {
				...
				profile5.setEmail("RnjithaLaggere@Gmail.com");
				...
				profile6.setEmail("SteffiBelgavi@Gmail.com");
			...
			void testUpdate() {
				...
				uc.setLastName("Pune");
				uc.setEmail("LakshmiPuneRadhika@Gmail.com");
